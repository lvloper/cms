...
**Citas:** `app/Filament/Templates/DefaultTemplate.php`, `app/Filament/Templates/ModalTemplate.php`, `app/Filament/Traits/BlockComposer.php`, `app/Filament/Blocks/HeroBlock.php`, `app/Filament/Blocks/TextBlock.php`, `resources/views/components/blocks.blade.php`, `resources/views/blocks/Hero.blade.php`
...
- Atajos de formulario para no repetir lógica: selector de rutas, imágenes (desktop/mobile), TipTap/Rich, iconos.
...
**Citas:** `app/Filament/Traits/FormShortcuts.php`, `resources/views/components/link.blade.php`, `resources/views/components/image.blade.php`, `resources/views/components/layout.blade.php`, `resources/views/components/common/header.blade.php`, `resources/views/pages/blocksList.blade.php`
