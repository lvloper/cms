  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        socies: {
          green: 'var(--color-socies-green)',
          blue: 'var(--color-socies-blue)',
          yellow: 'var(--color-socies-yellow)',
          coral: 'var(--color-socies-coral)',
          violet: 'var(--color-socies-violet)',
          aqua: 'var(--color-socies-aqua)',
        },
